        ...
        <div className='news'>
            <div className="news-container">
                <div className="container-head">
                    ...
                    <h2 className='subtitle'>Nuestro proposito es, que pases el ENARM en tú primer intento.</h2>
                    <p>Este año te ofrecemos una preparación radicalmente superior, totalmente actualizada y mejorada con nuevas herramientas y contenido, ya que nuestra meta es llegar a más del 85% de nuestros alumnos aprobados en su primer intento.</p>
                </div>
