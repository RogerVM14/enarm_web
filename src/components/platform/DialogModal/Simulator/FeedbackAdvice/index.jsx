      ...
      <div className={ui.modalContainer}>
        <div className={ui.containerHead}>
          <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
            <g clip-path="url(#clip0_2863_1971)">
        ...
        <div className={ui.containerBody}>
          <p>Si detienes el Simulador ahora, el intento del se marcará como completado.</p>
        </div>
        <div className={ui.containerFooter}>
          <div className={ui.footerButtons}>
            <button type="button" className={ui.buttonCancel}>
              <span>No, volver</span>
            </button>
