...
const course = [
  ...
  },
  {
    week: 3,
    classes: [
      { title: "Cardiologia", days: 6, id: "cardiologia" }
    ],
  ...
  },
  {
    week: 6,
    classes: [
      { title: "Gastroenterologia", days: 6, id: "gastroenterologia" }
    ],
  ...
  {
    week: 22,
    classes: [{ title: "Cardiología", days: 1, id: "cardiologia" }, { title: "Dermatologia", days: 6, id: "dermatologia" },],
    simulator: { title: "SimuladorPro - Cardio y Derma", days: 0 },
    status: 0
  },
  {
    week: 23,
    classes: [{ title: "Cardiologia", days: 3, id: "cardiologia" }, { title: "Gastroenterologia", days: 3, id: "gastroenterologia" },],
    simulator: { title: "SimuladorPro - Derma y Gastro + Simulacro 25...", days: 0 },
    status: 0
  },
  {
  ...
  {
    week: 25,
    classes: [{ title: "Gastroenterologia", days: 1, id: "gastroenterologia" }, { title: "Nefrologia", days: 6, id: "nefrologia" },],
    simulator: { title: "SimuladorPro - Cardio y Nefro", days: 0 },
    status: 0
  },
  {
    week: 26,
    classes: [{ title: "Nefrologia", days: 1, id: "nefrologia" }, { title: "Neumologia", days: 6, id: "neumologia" },],
    simulator: { title: "SimuladorPro - Nefro y Neumo", days: 0 },
    status: 0
  },
  {
    week: 27,
    classes: [{ title: "Neumologia", days: 3, id: "neumologia" }, { title: "Urgencias", days: 3, id: "urgencias" },],
    simulator: { title: "SimuladorPro - Neumo y Urgencias + Simulacro 200 pre...", days: 0 },
    status: 0
  },
  {
    week: 28,
    classes: [{ title: "Urgencias", days: 5, id: "urgencias" }, { title: "Reumatologia", days: 1, id: "reumatologia" },],
    simulator: { title: "SimuladorPro - Urgencias y Reuma", days: 0 },
    status: 0
  },
  {
  ...
  {
    week: 38,
    classes: [{ title: "Dermatología", days: 3, id: "dermatologia" }, { title: "Gastroenterologia", days: 3, id: "gastroenterologia" },],
    simulator: { title: "SimuladorPro - Derma y Gastro + Simulacro 25...", days: 0 },
    status: 0
  },
  {
  ...
  },
  {
    week: 42,
    classes: [
      { title: "Neumologia", days: 3, id: "neumologia" }, { title: "Urgencias", days: 3, id: "urgencias" },],
    simulator: { title: "SimuladorPro - Neumo y Urgencias + Simulacro 200 pre...", days: 0 },
    status: 0
  },
  {
