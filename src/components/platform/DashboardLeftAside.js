...
const DashboardLeftAside = (props) => {
    ...
    const asideNavigationItems = [
       ...
       /* pos: 1 */ { route: "/u/planes/11_meses", label: "11 Meses", hasDDL: false, },
       /* pos: 2 */ { route: "/u/planes/10_meses", label: "10 Meses", hasDDL: false, },
       /* pos: 3 */ { route: "/u/planes/9_meses", label: "9 Meses", hasDDL: false, },
       /* pos: 4 */ { route: "/u/planes/8_meses", label: "8 Meses", hasDDL: false, },
       /* pos: 5 */ { route: "/u/planes/7_meses", label: "7 Meses", hasDDL: false, },
       /* pos: 6 */ { route: "/u/planes/6_meses", label: "6 Meses", hasDDL: false, },
       /* pos: 7 */ { route: "/u/planes/5_meses", label: "5 Meses", hasDDL: false, },
       /* pos: 8 */ {
            route: "/u/recursos",
            label: "Recursos",
            hasDDL: false,
    ...
    const navLinkClass = (index, isAct) => {
        ...
        if (isActiveNav) { classString += " active" }
    ...
    return (
        <aside
            ...
            style={isSmart ? (
                menuActive ? { display: "block" } : { display: "none" }
            ) : (
                { display: "block" }
            )}
        >
            <nav>
                <div className="navigation-wrapper">
                    ...
                    {
                        isSmart && <div className='menu-close' onClick={() => { props.handleCloseMenu() }}>
                ...
                <div className="aside-footer">
                    {
                        isSmart ? (
                            <div className='session-user smart'>
                                <div className="user-info" onClick={() => { setSessionTools(!isShowingSessionTools) }}>
                                    <img src={userIcon} alt="user-img" className="user-icon" />
                                    <span className="roboto-14 black">{user_data.username}</span>
                                    ...
                                    isShowingSessionTools && (
                                        <div className="session-container-tools">
                                            ...
                                            <div onClick={() => { logout() }}>
                                                ...
                                                <span className='roboto-14' style={{ fontWeight: "400" }}>Cerrar Sesión</span>
                                            </div>
                                        </div>
                                    )
                                }
