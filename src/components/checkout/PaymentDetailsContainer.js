            ...
            <div className="details-payments">
                <div className="details">
                    <div className="details__top">
                        <h1 className={`medium-${isMobile ? "29 text-center" : "33"}`}>Detalles de compra</h1>
                        <p className={regularText()}>Curso: <strong className={boldText()}>Paquete 11 meses</strong></p>
                        <p className={regularText()}>Duración: <strong className={boldText()}>11 meses</strong></p>
                    </div>
                    <hr />
                ...
                <div className="message">
                    <img style={{ display: 'block', width: '24px', height: '24px' }} src={greenshield} alt="greenshield" />
                    <p className={`${regularText()} white`}>
                        Plataforma ENARM garantiza pago seguro y acceso inmediato a los contenidos.
                        <br /><br />
                        Recuerda que los medios de pago aquí presentes son los únicos que respaldan que tu operación sea segura y exitosa.
                        <br /><br />
                        <span className={boldText()}>¡No solicitamos pagos por otros medios!</span>
                    </p>
                </div>
                <div className={`checkout-payment ${size}`}>
                    <button className='button-rounded-blue-48' type='submit' onClick={() => { navigate('/checkout_thankful') }}>
                        <span className='button-text'>Aceptar compra</span>
                    </button>
                    <p className='regular-12' >
                        Al presionar el botón Aceptar compra accedes a adquirir el curso. Gracias por confirmar en nuestro servicio.
                    </p>
                </div>
            </div>
        </div>
