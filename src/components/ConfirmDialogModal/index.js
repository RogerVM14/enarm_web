          ...
          <div className="p-4 sm:p-5 text-center">
            ...
            <div className="flex justify-center gap-2">
              ...
              <button
                onClick={onCancel}
                type="button"
                className="w-full sm:w-auto py-2 px-4 sm:py-2.5 sm:px-5 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600"
              >
                {cancelText}
              </button>
            </div>
