...
import '../css/RegularQuestions.css';
...
const RegularQuestions = () => {
    ...
    return (
        <div className='regular-questions'>
            <div className="regular-questions-container">
                <div className="regular-questions-container-head">
                    <h1 className='title'>PREGUNTAS FRECUENTES</h1>
                    <h2 className='subtitle'>Algunos de nuestros alumnos han preguntado:</h2>
                </div>
                <div className="regular-questions-container-body">
