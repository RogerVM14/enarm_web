        ...
        <div className='how-it-works'>
            <div className="hiw-container">
                ...
                <div className="hiw-container body">
                    ...
                    <img className='hiw-icon icon-1' src={drThumb} alt="drThumb" />
                    <img className='hiw-icon icon-2' src={bookImg} alt="bookImg" />
                    <img className='hiw-icon icon-3' src={starImg} alt="starImg" />
                    <img className='hiw-icon icon-4' src={drWalking} alt="drWalking" />
                    <img className='hiw-icon icon-5' src={halfDr} alt="halfDr" />
                </div>
            </div>
        </div>
    )
