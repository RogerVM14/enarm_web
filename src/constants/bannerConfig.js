// Configuración local para los banners
// Cambiar a true para mostrar el banner, false para ocultarlo
export const BANNER_CONFIG = {
  ...
  BANNER_DISMISSIBLE: true, // Si el usuario puede cerrar el banner
};
