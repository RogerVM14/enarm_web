        ...
        <div className="container-section">
          <div className={ui.containerFlex}>
            ...
            <div className={ui.flexInformation}>
              ...
              <p className="regular-parraf">Obten una beca del <span className="strong">30% del descuento.</span></p>
              <h3 className="section-title" style={{ marginBottom: "2px" }}>MX $7,000</h3>
              ...
              <Link to={ROUTES.REGISTRO} className={ui.blueLink}>Inscribirme ahora</Link>
            </div>
          </div>
        </div>
      </div>
